...
function abcfsl_mbox_item_optns( $itemOptns, $tplateOptns ){
    ...
    echo  abcfl_html_tag('div','CN5','inside hidden abcflFadeIn');
        ...
        //----------------------------------------------------
        $lblPretty = abcfl_input_sec_title_hlp( ABCFSL_ICONS_URL, abcfsl_txta(231), abcfsl_aurl(60), 'abcflFontWP abcflFontS13 abcflFontW600' );
        $lblPgTitle = abcfl_input_sec_title_hlp( ABCFSL_ICONS_URL, abcfsl_txta(77), abcfsl_aurl(102), 'abcflFontWP abcflFontS13 abcflFontW600' );

        echo abcfl_input_hline('1', '10');
        echo abcfl_input_sec_title_hlp( ABCFSL_ICONS_URL, abcfsl_txta(303), abcfsl_aurl(101) );
        //echo abcfl_input_txt('pretty', '', $pretty,  abcfsl_txta(231), abcfsl_txta(270) . ' ' . abcfsl_txta(232), '50%', '', '', 'abcflFldCntr', 'abcflFldLbl');
        echo abcfl_input_txt('pretty', '', $pretty,   $lblPretty, abcfsl_txta(270) . ' ' . abcfsl_txta(232), '50%', '', '', 'abcflFldCntr', 'abcflFldLbl');

        //Html Head Title
        //echo abcfl_input_txt('sPgTitle', '', $sPgTitle,  abcfsl_txta(77), abcfsl_txta(270), '50%', '', '', 'abcflFldCntr', 'abcflFldLbl');
        echo abcfl_input_txt('sPgTitle', '', $sPgTitle,  $lblPgTitle, abcfsl_txta(270), '50%', '', '', 'abcflFldCntr', 'abcflFldLbl');
        //----------------------------------------------------
        echo abcfl_input_hline('1', '10');
        abcfsl_mbox_tplate_field_section_hdr( 73, 367, false);
