...
function abcfsl_mbox_autil_input_four_fields( $data1, $data2, $data3, $data4, $w1, $w2, $w3, $w4, $cntrW ){
    ...
    $divS2 = abcfl_html_tag( 'div', '', 'abcflFG' . $w2 . 'P' );
    $divS3 = abcfl_html_tag( 'div', '', 'abcflFG' . $w3 . 'P' ); 
    $divS4 = abcfl_html_tag( 'div', '', 'abcflFG' . $w4 . 'P' );    
    $divE = abcfl_html_tag_end( 'div');

    return $flexCntrS . $divS1 . $data1 . $divE . $divS2 . $data2 . $divE . $divS3 . $data3 . $divE . $divS4 . $data4 . $divE . $divE;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
