...
function abcfsl_mbox_item_img( $itemOptns, $tplateOptns ){
    ...
    $sPgLnkCustTxt = isset( $itemOptns['_sPgLnkCustTxt'] ) ? esc_attr( $itemOptns['_sPgLnkCustTxt'][0] ) : '';
    ...
    //-- IMG LINK -----------------------------------------------------------
    abcfsl_mbox_item_img_link_cntr( $imgLnkL, $sPgLnkNT, $imgLnkLDefault, $imgLnkArgs, $imgLnkClick, $sPgLnkShow, $sPgLnkTxt, $sPgLnkCustTxt );
...
function abcfsl_mbox_item_img_link_cntr( $imgLnkL, $sPgLnkNT, $imgLnkLDefault, $imgLnkArgs, $imgLnkClick, $sPgLnkShow, $sPgLnkTxt, $sPgLnkCustTxt ){
    ...
    $lnkCustTxt = abcfl_input_txt('sPgLnkCustTxt', '', $sPgLnkCustTxt, abcfsl_txta(900), '', '100%', '', '', 'abcflFldCntr', 'abcflFldLbl');
    ...
    //echo abcfsl_mbox_autil_input_three_fields( $roImgLnkTpltOptns, $roTxtLnkTpltOptns, $imgLnkL, 8, 16, 70, 100 );
    
    //abcfsl_mbox_autil_input_four_fields( $data1, $data2, $data3, $data4, $w1, $w2, $w3, $w4, $cntrW );
    echo abcfsl_mbox_autil_input_four_fields( $roImgLnkTpltOptns, $roTxtLnkTpltOptns, $lnkCustTxt, $imgLnkL, 8, 10, 18, 60, 100 );
...
function abcfsl_mbox_item_img_link_ro_values ( $imgLnkLDefault, $sPgLnkNT, $sPgLnkShow, $sPgLnkTxt ){
    ...
    // sPgLnkShow Page type: N, S, ST, SPHYB SPGCUST SPCUST. 
    ...
    if( $sPgLnkShow == 'SPHYB' ) { 
        if( $imgLnkLDefault == 1 ) { 
            $out['imgLnkOptns'] = $pfix . 'HB';
        }
        if( !empty( $sPgLnkTxt ) ) { 
            $out['txtLnkOptns'] = $pfix . 'HB ' . $sPgLnkTxt;
        }
        return $out;         
    }
    ...
    if( $sPgLnkShow == 'SPCUST' ) { 
        if( $imgLnkLDefault == 1 ) { 
            $out['imgLnkOptns'] = $pfix  . 'CUST';
        }
        if( !empty( $sPgLnkTxt ) ) { 
            $out['txtLnkOptns'] = $pfix  . 'CUST ' . $sPgLnkTxt;
        } 
        return $out;         
    }
    return $out; 
