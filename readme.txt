...
Over [30 field types](https://abcfolio.com/wordpress-plugin-staff-list/documentation/field-types/) to choose from.
...
=  1.7.4 20231220
* Update: Option to replace template's single page text link with staff member custom text.
* Update: Tested with WP 6.4.
